...
//         style={{ paddingBottom: "100px", gap: "20px" }} // gap adds space between items
//       >
...
const Team = () => {
  return (
    <div className="container">
      <div className="text-center team mb-5">
        <h1 style={{ fontFamily: "Playfair Display", fontSize: "40px" }}>
          We Pride Ourselves On Having A <br /> Team Of Highly Skilled
        </h1>
        <p>Preorder now to receive exclusive deals & gifts</p>
      </div>
      ...
      <div className="row" style={{ paddingBottom: "100px" }}>
        ...
        <div className="col-md-4 col-lg-4 ms-3 team-member text-center">
          <img
            src={team2}
            className="rounded-circle mb-4"
            alt="Team Member 2"
        ...
        <div className="col-md-4 team-member text-center col-lg-4 ms-3">
          <img
            src={team3}
            className="rounded-circle mb-4"
            alt="Team Member 3"
